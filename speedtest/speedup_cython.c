/* Generated by Cython 0.13 on Tue Dec  7 12:43:28 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__speedup_cython
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from speedup_cython */

static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), 'R' };
#define __Pyx_MODULE_NAME "speedup_cython"
int __pyx_module_is_main_speedup_cython = 0;

/* Implementation of speedup_cython */
...
/* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":12
 * 
...
static PyObject *__pyx_pf_14speedup_cython_gradient(PyObject *__pyx_self, PyObject *__pyx_v_depth); /*proto*/
static PyObject *__pyx_pf_14speedup_cython_gradient(PyObject *__pyx_self, PyObject *__pyx_v_depth) {
  PyObject *__pyx_v_h;
  PyObject *__pyx_v_w;
  ...
  Py_ssize_t __pyx_bstride_1_dx = 0;
  Py_ssize_t __pyx_bshape_0_dx = 0;
  Py_ssize_t __pyx_bshape_1_dx = 0;
  Py_buffer __pyx_bstruct_dy;
  Py_ssize_t __pyx_bstride_0_dy = 0;
  Py_ssize_t __pyx_bstride_1_dy = 0;
  Py_ssize_t __pyx_bshape_0_dy = 0;
  Py_ssize_t __pyx_bshape_1_dy = 0;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_depth), __pyx_ptype_5numpy_ndarray, 1, "depth", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_depth, (PyObject*)__pyx_v_depth, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":13
 * @cython.boundscheck(False)
 * def gradient(np.ndarray[np.float32_t,ndim=2,mode='c'] depth):
 *   h,w = depth.shape[0], depth.shape[1]             # <<<<<<<<<<<<<<
 *   cdef np.ndarray[np.float32_t,ndim=2,mode='c'] dx = np.zeros((h,w),np.float32)
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_to_py_Py_intptr_t((((PyArrayObject *)__pyx_v_depth)->dimensions[0])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_to_py_Py_intptr_t((((PyArrayObject *)__pyx_v_depth)->dimensions[1])); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":14
 * def gradient(np.ndarray[np.float32_t,ndim=2,mode='c'] depth):
 *   h,w = depth.shape[0], depth.shape[1]
 *   cdef np.ndarray[np.float32_t,ndim=2,mode='c'] dx = np.zeros((h,w),np.float32)             # <<<<<<<<<<<<<<
 *   cdef np.ndarray[np.float32_t,ndim=2,mode='c'] dy = np.zeros((h,w),np.float32)
 ...
 */
  ...
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__float32); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_2 = 0;
  __pyx_t_4 = 0;
  __pyx_t_4 = PyObject_Call(__pyx_t_1, __pyx_t_3, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dx, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {
    ...
    } else {__pyx_bstride_0_dx = __pyx_bstruct_dx.strides[0]; __pyx_bstride_1_dx = __pyx_bstruct_dx.strides[1];
      __pyx_bshape_0_dx = __pyx_bstruct_dx.shape[0]; __pyx_bshape_1_dx = __pyx_bstruct_dx.shape[1];
    }
  }
  __pyx_t_5 = 0;
  ...
  /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":15
 *   h,w = depth.shape[0], depth.shape[1]
 *   cdef np.ndarray[np.float32_t,ndim=2,mode='c'] dx = np.zeros((h,w),np.float32)
 *   cdef np.ndarray[np.float32_t,ndim=2,mode='c'] dy = np.zeros((h,w),np.float32)             # <<<<<<<<<<<<<<
 * 
 *   for i from 1 < i < h-1:
 */
  __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__zeros); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__float32); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_4 = 0;
  __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_3, __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dy, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_dy = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_dy.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_dy = __pyx_bstruct_dy.strides[0]; __pyx_bstride_1_dy = __pyx_bstruct_dy.strides[1];
      __pyx_bshape_0_dy = __pyx_bstruct_dy.shape[0]; __pyx_bshape_1_dy = __pyx_bstruct_dy.shape[1];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_dy = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":17
 *   cdef np.ndarray[np.float32_t,ndim=2,mode='c'] dy = np.zeros((h,w),np.float32)
 * 
 *   for i from 1 < i < h-1:             # <<<<<<<<<<<<<<
 *     for j from 1 < j < w-1:
 ...
 */
  __pyx_t_2 = PyNumber_Subtract(__pyx_v_h, __pyx_int_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_7 = __Pyx_PyInt_AsLong(__pyx_t_2); if (unlikely((__pyx_t_7 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  for (__pyx_t_8 = 1+1; __pyx_t_8 < __pyx_t_7; __pyx_t_8++) {
    __pyx_t_2 = PyInt_FromLong(__pyx_t_8); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_v_i);
    __pyx_v_i = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":18
 * 
 *   for i from 1 < i < h-1:
 *     for j from 1 < j < w-1:             # <<<<<<<<<<<<<<
 *       dy[i,j] = (depth[i+1,j]-depth[i-1,j])/2
 ...
 */
    __pyx_t_2 = PyNumber_Subtract(__pyx_v_w, __pyx_int_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_9 = __Pyx_PyInt_AsLong(__pyx_t_2); if (unlikely((__pyx_t_9 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    for (__pyx_t_10 = 1+1; __pyx_t_10 < __pyx_t_9; __pyx_t_10++) {
      __pyx_t_2 = PyInt_FromLong(__pyx_t_10); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_v_j);
      __pyx_v_j = __pyx_t_2;
      __pyx_t_2 = 0;

      /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":19
 *   for i from 1 < i < h-1:
 *     for j from 1 < j < w-1:
 *       dy[i,j] = (depth[i+1,j]-depth[i-1,j])/2             # <<<<<<<<<<<<<<
 *       dx[i,j] = (depth[i,j+1]-depth[i,j-1])/2
 *   return dx, dy
 */
      __pyx_t_2 = PyNumber_Add(__pyx_v_i, __pyx_int_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      ...
      __pyx_t_2 = 0;
      __pyx_t_2 = PyObject_GetItem(__pyx_v_depth, __pyx_t_1); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyNumber_Subtract(__pyx_v_i, __pyx_int_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      ...
      __Pyx_GIVEREF(__pyx_v_j);
      __pyx_t_1 = 0;
      __pyx_t_1 = PyObject_GetItem(__pyx_v_depth, __pyx_t_3); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = PyNumber_Subtract(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_int_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = PyTuple_New(2); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      ...
      PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_v_j);
      __Pyx_GIVEREF(__pyx_v_j);
      if (PyObject_SetItem(((PyObject *)__pyx_v_dy), __pyx_t_3, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

      /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":20
 *     for j from 1 < j < w-1:
 *       dy[i,j] = (depth[i+1,j]-depth[i-1,j])/2
 *       dx[i,j] = (depth[i,j+1]-depth[i,j-1])/2             # <<<<<<<<<<<<<<
 *   return dx, dy
 * 
 */
      __pyx_t_1 = PyNumber_Add(__pyx_v_j, __pyx_int_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      ...
      __Pyx_GIVEREF(__pyx_t_1);
      __pyx_t_1 = 0;
      __pyx_t_1 = PyObject_GetItem(__pyx_v_depth, __pyx_t_3); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = PyNumber_Subtract(__pyx_v_j, __pyx_int_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __pyx_t_3 = 0;
      __pyx_t_3 = PyObject_GetItem(__pyx_v_depth, __pyx_t_2); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = PyNumber_Subtract(__pyx_t_1, __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_int_2); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = PyTuple_New(2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      ...
      __Pyx_GIVEREF(__pyx_v_j);
      if (PyObject_SetItem(((PyObject *)__pyx_v_dx), __pyx_t_2, __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_10 = __Pyx_PyInt_AsLong(__pyx_v_j); if (unlikely((__pyx_t_10 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
 ...
 *       dx[i,j] = (depth[i,j+1]-depth[i,j-1])/2
 */
    __pyx_t_3 = PyInt_FromLong(__pyx_t_10); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_v_j);
    __pyx_v_j = __pyx_t_3;
    __pyx_t_3 = 0;
    __pyx_t_8 = __Pyx_PyInt_AsLong(__pyx_v_i); if (unlikely((__pyx_t_8 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 *       dy[i,j] = (depth[i+1,j]-depth[i-1,j])/2
 */
  __pyx_t_3 = PyInt_FromLong(__pyx_t_8); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_v_i);
  __pyx_v_i = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":21
 *       dy[i,j] = (depth[i+1,j]-depth[i-1,j])/2
 *       dx[i,j] = (depth[i,j+1]-depth[i,j-1])/2
 *   return dx, dy             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_3, 0, ((PyObject *)__pyx_v_dx));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_dx));
  __Pyx_INCREF(((PyObject *)__pyx_v_dy));
  PyTuple_SET_ITEM(__pyx_t_3, 1, ((PyObject *)__pyx_v_dy));
  ...
  __Pyx_AddTraceback("speedup_cython.gradient");
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_depth);
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("gradient"), (PyCFunction)__pyx_pf_14speedup_cython_gradient, METH_O, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initspeedup_cython(void); /*proto*/
PyMODINIT_FUNC initspeedup_cython(void)
#else
PyMODINIT_FUNC PyInit_speedup_cython(void); /*proto*/
PyMODINIT_FUNC PyInit_speedup_cython(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  #if CYTHON_REFNANNY
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_speedup_cython(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("speedup_cython"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_speedup_cython) {
  ...
  /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":2
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
  ...
  /* "/Users/amiller/Desktop/libfreenect-goodies/speedtest/speedup_cython.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init speedup_cython");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init speedup_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
